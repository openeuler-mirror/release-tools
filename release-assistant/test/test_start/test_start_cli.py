...
[INFO] start update successfully.
        ...
        self.command_params = ["--giteeid=Mary", "--token=release-tools", "I40321"]
        ...
        self.mock_request(side_effect=[resp, resp, resp, resp, resp, mock_init_r])
...
Parameter validation failed
        """
        self.command_params = ["--giteeid=Mary", "--token=release-tools", ""]
        self.assert_result()

    def test_request_status_408(self):
        """test_request_status_408"""
        self.expect_str = """
[ERROR] no personnel authority
"""
        self.command_params = ["--giteeid=Mary", "--token=xxx", "I40321"]
...
[ERROR] The current user does not have relevant operation permissions
        ...
        self.command_params = ["--giteeid=onetwothree", "--token=xxx", "I40321"]
        resp = self.make_expect_data(200, 'startpart.txt')
...
[ERROR] failed to start update.
    ...
    def test_already_operated(self):
        ...
        """
        self.expect_str = """
Issue has CVE content, have you already operated start update command
[ERROR] failed to start update.
        """
        self.command_params = ["--giteeid=Mary", "--token=xxx", "I40321"]
        resp = self.make_expect_data(200, 'startpart.txt')
